...
export class UI {
    static createPokemonCard = (pokemon, typeColors) => {
    ...
    static renderDetails = (pokemon, evoSprites, typeColors) => {
    ...
    static createHuntAlert = (pokemon, x, y) => {
    ...
    static createHuntMissAlert = (x, y) => {
        const card = document.createElement("div");
    ...
    static setupBattleField = (wild, player, wildMaxHP, playerMaxHP) => {
    ...
    static renderTeamSelector = (favorites, wildId) => {
