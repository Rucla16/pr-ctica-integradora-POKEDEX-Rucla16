...
Los 5 archivos comparten el mismo <header> para permitir el acceso de una página a la otra. El index tiene un buscador funcional para poder buscar cualquiera de los 151 primeros Pokemons, tambien los carga de forma automática en pantalla.
